      ...
      (this.Ponto = ponto.map(
        (ponto) =>
          new Ponto(
            ...
            ponto.po_dthrreal,
            ponto.po_observacao,
            ponto.po_histdtcadastro,
            ponto.po_histuscadastro,
            ponto.po_histdtalteracao,
            ponto.po_histusalteracao,
            ponto.po_histdtdeletado,
            ponto.po_histusdeletado,
            ponto.po_deletado,
            ponto.po_tipobatida,
            ponto.po_aplicativo
          )
